...
typedef void (*StrategyCallback)(struct Strategy *, int);
 ...
 */
void ethernet_set_speed(EthernetStrategy * self, int speed) {
 ...
 */
void serial_set_speed(SerialStrategy * self, int speed) {
    (void) self; // not needed at this moment
 ...
 */
void  fan_unit_set_control_strategy(FanUnit * self, Strategy * strategy)  {
